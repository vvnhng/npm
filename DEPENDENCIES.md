...
packages higher up the chain.
 ...
 - @npmcli/docs, @npmcli/fs, @npmcli/map-workspaces, @npmcli/metavuln-calculator, @npmcli/run-script, libnpmhook, libnpmorg, libnpmsearch, libnpmteam, @npmcli/git
 - @npmcli/eslint-config, @npmcli/template-oss, semver, @npmcli/installed-package-contents, @npmcli/name-from-folder, @npmcli/node-gyp, @npmcli/package-json, @npmcli/query, @npmcli/promise-spawn, @npmcli/disparity-colors, abbrev, write-file-atomic
